...
namespace MetaFeedConsole
{
	static class StringExtensions
	{
		...
		internal static void ConsoleWrite(this string text, ConsoleColor foregroundColor, ConsoleColor backgroundColor, bool writeToLog)
		{
			ConsoleWrite(text, foregroundColor, backgroundColor, false, writeToLog);
		}

		internal static void ConsoleWriteLine(this string text, ConsoleColor foregroundColor, ConsoleColor backgroundColor, bool writeToLog)
		{
		...
		internal static void ConsoleWrite(this string text, ConsoleColor foregroundColor, ConsoleColor backgroundColor, bool writeLine, bool writeToLog)
		{
